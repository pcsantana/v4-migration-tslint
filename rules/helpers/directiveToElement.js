...
function createDirectiveToElementTemplateVisitorClass(directive, resultantElement, level) {
...
function createDirectiveToElementRuleClass(ruleName, directive, resultantElement = directive, level = 'same') {
    var _a;
